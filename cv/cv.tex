...
\item[--] \emph{Expected Cummulative GPA} (on graduation): 9.60/10.00 (remainder of 8 courses and Thesis presentation) 
...
\item[2.] SalSAGAN: Spatio-Temporal Modeling via Transfer Learning for Video Saliency Estimation using Generative Adversarial Networks. \emph{Early stage work}. 
