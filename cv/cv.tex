...
\section{Research Interests} Algorithms, Information Networks, Network Economics, Systemic Risk, LLMs, Differential Privacy, Machine Learning, Data Mining, Computational Social Science
% \emph{Foci:} Statistical Modeling of Networks, Financial Networks, Graph ML 

\section{Education}
\field {Cornell University} {\emph{2020 -- Expected 2025}}
...
Diploma in Electrical and Computer Engineering \\ Major: \emph{Computer Science}.
\begin{itemize}[nosep]
...
\begin{itemize}[nosep]
	\item[--] \award{Onassis Scholarship}{2023}{Three-year fellowship for Greek Ph.D. students. Acceptance rate: 1-2\%.}
	...
	% \item[--] \award{Thomaidion Award}{2019}{}
...
\begin{enumerate}[nosep, label={[S\arabic*]}]
	\item \publication{Optimal Resource Allocation for Remediating Networked Contagions}{\authorme, Sid Banerjee, Jon Kleinberg}{Major Revision, Management Science}{2024}{\preprint{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4880536}} 
	
	\item  \publication{Network Formation and Dynamics among Multi-LLMs}{\authorme, Yuan Yuan}{Under review}{2024}{\preprint{http://arxiv.org/abs/2402.10659} \slides{https://drive.google.com/file/d/13Qm_82D0WrkmN1LAv2AUmjcputMOdm_y/view?usp=drive_link}} 
	...
	% \item \publication{Dynamic Interventions for Networked Contagions}{\authorme, Sid Banerjee, Jon Kleinberg}{ACM Web Conference (WWW)}{2023}{\paper{https://dl.acm.org/doi/abs/10.1145/3543507.3583470} \code{https://github.com/papachristoumarios/dynamic-clearing} \poster{https://drive.google.com/file/d/1l0TCsoZNo3NoOOHsPSh1ofctXD4ivFir/view?usp=sharing} \slides{https://drive.google.com/file/d/1ZZ6F6PFNsBjYKFyurkwM2IbenuzXJEAs/view?usp=share_link}}
\end{enumerate}}
...
\begin{enumerate}[nosep, label={[WP\arabic*]}]  
   ...
   \item \publication{Optimal Resource Allocation for Remediating Networked Contagions}{\authorme, Sid Banerjee, Jon Kleinberg}{Major Revision, Management Science}{2024}{\preprint{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4880536} \slides{https://drive.google.com/file/d/1DgOCnJ5Pf3Je-F7a-Adiy2TTZ7oZUbbB/view?usp=sharing}} 
      \item \publication{Group Decision-Making among Privacy-aware Agents}{\authorme, Amin Rahimian}{Under review at Operations Research}{2024}{
