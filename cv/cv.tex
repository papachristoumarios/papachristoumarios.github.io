...
\section{Research \\ Interests} Data Science, Machine Learning, Recommender Systems, Computational Law, Software Engineering, Algorithms, Optimization 
...
\item[1.] ``Stochastic Opinion Dynamics for Interest Prediction in Online Social Networks''. \emph{joint work with D. Fotakis. Submitted to NeurIPS 2020.}
...
\item[--] Develop software for the efficient sampling from high-dimensional log-concave densities using first-order oracles in (un)-truncated settings. Project can be found at \href{https://GeomScale/volume_approximation}{\nolinkurl{[github]}}
\end{compactitem}
...
\begin{compactitem}
	\item[--] Cornell New Student Fellowship (first-year) based on academic preparation and promise. Cornell University. 
