...
\begin{enumerate}[nosep, label={[W\arabic*]}]    
   ...
   \item \authorme, Sid Banerjee, Jon Kleinberg, ``Optimal Resource Allocation for Remediating Networked Contagions''. \emph{Under review.} 2023. 
...
\begin{itemize}[nosep]
	...
	\begin{itemize}[nosep]
		\item University of Chicago, Theory Seminar\scheduled \hfill \emph{October 2023}
