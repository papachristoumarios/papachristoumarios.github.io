...
\begin{compactenum}
   \item \authorme, Amin Rahimian. ``Cascading Failures, Power laws and Resiliency of Production Networks''. \emph{Under review.} 2023. 
...
%	\item[--] The Structure of Information Networks (PhD-level, Cornell) \hfill \emph{Spring 2023}
    \item[--] Discrete Mathematics (4th Semester, NTUA) \hfill \emph{Spring 2017}
    \item[--] Programming Techniques (2nd Semester, NTUA) \hfill \emph{Spring 2016}
    \item[--] Introduction to Computer Programming (1st Semester, NTUA) \hfill \emph{Fall 2016, Fall 2017}
\end{compactitem}
