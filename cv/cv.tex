...
\newcommand{\specialurl}[2]{\href {#2} {{{\texttt{[#1]}}}}\hspace{0pt}}
...
\begin{enumerate}[nosep, label={[J\arabic*]}]
   ...
   \item \publication[\item Taught at UC Berkeley, Stanford, UIUC and others \item Featured by PNAS Nexus at EurekAlert! \news{https://www.eurekalert.org/news-releases/1107359} \item Featured by TechXplore \news{https://techxplore.com/news/2025-12-llms-friends-colleagues-people.html}]{Network Formation and Dynamics among Multi-LLMs}{\authorme, Yuan Yuan}{PNAS Nexus}{2025}{\preprint{http://arxiv.org/abs/2402.10659} \code{https://github.com/papachristoumarios/llm-network-formation}} 
      
   	
   \item \publication[\item Invited talk at the LLMs as Research Tools Workshop at ACM CHI 2024 \item Featured by the ACM  \news{https://link.growkudos.com/1elazzumi9s}]{Leveraging Large Language Models for Collective Decision-Making}{\authorme, Longqi Yang, Chin-Chia Hsu}{Proceedings of the ACM on Human Computer Interaction (presented at ACM CSCW '25)}{2025}{\paper{https://doi.org/10.1145/3757418}}
