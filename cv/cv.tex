...
\section{Research \\ Interests} Data Science (information networks, statistical methods, fairness in networks)
...
\begin{compactitem}
    ...
    \item [1.] \underline{\textbf{Papachristou, Marios}} ``Sublinear Domination and Core--periphery networks''. 2021, Preprint. \href{https://arxiv.org/abs/2103.03135} {\nolinkurl{[arxiv]}} 
    \item [2.] Chalkis, Apostolos, Fisikopoulos Vissarion, \underline{\textbf{Papachristou, Marios\alphabeticalorder}}, and Tsigaridas, Elias. ``Truncated Log-concave Sampling with Reflective Hamiltonian Monte Carlo''. 2021, Preprint. \href{https://arxiv.org/abs/2102.13068}{\nolinkurl{[arxiv]}}
    \item[3.] \underline{\textbf{Papachristou, Marios}},and Fotakis, Dimitris. ``Stochastic Opinion Dynamics for User Interest Prediction in Online Social Networks''. 2020, \emph{Submitted.}
    \item[4.] \underline{\textbf{Papachristou, Marios}}. ``Software clusterings with vector semantics and the call graph''. ESEC/FSE 2019. DOI: 10.1145/3338906.3342483. \href{https://dl.acm.org/citation.cfm?id=3342483}{\nolinkurl{[link]}}
    \item[5.] Kostakis, Vasilis, and \underline{\textbf{Papachristou, Marios}}. ``Commons-based peer production and digital fabrication: The case of a RepRap-based, Lego-built 3D printing-milling machine''. T\&I, 2014. DOI: 10.1016/j.tele.2013.09.006. \href{https://bit.ly/2JRoisV}{\nolinkurl{[link]}} \end{compactitem}
