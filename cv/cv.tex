...
\section{Research \\ Interests} Data Science (Theoretical and Practical Aspects)
...
\item[--] \emph{GPA:} 4.0
\item[--] \emph{Coursework:} Analysis of Algorithms, Optimal Stopping, Information Networks
\end{compactitem} 
