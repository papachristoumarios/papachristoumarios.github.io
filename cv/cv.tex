...
\begin{compactenum}
   \item \authorme, Rishab Goel, Frank Portman, Matt Miller, Rong Jin. ``GLINKX: A Scalable Unified Framework for Homophilous and Heterophilous Graphs''. \emph{Under Review}, 2022.
...
\begin{compactitem}
\item[--] Research on \emph{scalable machine learning on graphs}. Development of a simple scalable method for node classification in homophilous and heterophilous graphs. 
\end{compactitem}
