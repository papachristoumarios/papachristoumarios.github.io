...
\begin{compactitem}
\item[--] \emph{GPA:} 3.8/4.0 (top 1\%). \emph{Major:} Computer Science. \emph{Advisor:} Dimitris Fotakis.
...
\begin{compactenum}
   \item \alphabeticalorder Banerjee, Sid, Kleinberg, Jon, and \authorme. ``Dynamically Allocating Resources on a Contagion Environment''. 2022. \emph{Work in Progress.}
   \item \authorme, and Kleinberg, Jon. ``Core-periphery Models for Hypergraphs''. 2022. \emph{Under review.}
   \item  \authorme, and Kleinberg, Jon. ``Allocating Stimulus Checks in Times of Crisis''. 2021, \emph{WWW '22} \preprint{https://arxiv.org/abs/2106.07560} \code{https://github.com/papachristoumarios/financial-contagion}     
