...
\field{1st General Lyceum of Hymettus} {\emph{2012--2015}} 
    Apolytirion, Valedictorian, GPA: 19.8/20, National Exams: 18,971/20,000 (top 2\%)
...
\textbf{White Noise (Control Systems Engineer)} \hfill \emph{October 2018 --October 2019}

\begin{compactitem}
\item[--] Responsible for the development of an autogyro descent control system \href{https://github.com/white-noise-ntua}{\nolinkurl{[repos]}}
\item[--] Design the control system using state feedback linear controller with optimal gains
\end{compactitem}
